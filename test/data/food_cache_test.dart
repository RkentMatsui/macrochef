...
void main() {
  ...
  test('find returns most-recently-inserted row when no override exists',
      () async {
  ...
  test('fibre100 round-trips through put and find', () async {
    await repo.put(FoodMacros(
      name: 'oats-fibre',
      perHundred: const PerHundred(
          kcal: 380, protein: 13, carb: 66, fat: 7, fibre: 10.6),
  ...
  test('fibre100 round-trips through upsertOverride', () async {
    await repo.upsertOverride(FoodMacros(
      name: 'broccoli',
      perHundred: const PerHundred(
          kcal: 34, protein: 2.8, carb: 6.6, fat: 0.4, fibre: 2.6),
